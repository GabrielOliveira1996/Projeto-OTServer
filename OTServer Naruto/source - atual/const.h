...
{
	STORAGE_AKAMARU_IDENTIFIER = 85220,
};

namespace VocationConstants
{
	static const uint32_t KIBA_VOCATIONS[] = {33, 34, 35, 36, 37};
	static const size_t KIBA_VOCATIONS_SIZE = 5;
}
...
enum MagicEffect_t
{
	...
	MAGIC_EFFECT_NOVOONE = 0x45,		  // 70
	MAGIC_EFFECT_NOVOTWO = 0x46,		  // 71
	MAGIC_EFFECT_NOVOTHREE = 0x47,		  // 72
	MAGIC_EFFECT_NOVOFOUR = 0x48,		  // 73
	MAGIC_EFFECT_NOVOFIVE = 0x49,		  // 74
	MAGIC_EFFECT_NOVOSIX = 0x50,		  // 75
	MAGIC_EFFECT_NOVOSEVEN = 0x51,		  // 76
	MAGIC_EFFECT_NOVOEIGHT = 0x52,		  // 77
	MAGIC_EFFECT_NOVONINE = 0x53,		  // 78
	MAGIC_EFFECT_NOVOTEN = 0x54,		  // 79
	MAGIC_EFFECT_NOVOELEVEN = 0x55,		  // 80
	MAGIC_EFFECT_NOVOTWOEVEN = 0x56,	  // 81
	MAGIC_EFFECT_NOVOTHREEEVEN = 0x57,	  // 82
	MAGIC_EFFECT_NOVOFOUREVEN = 0x58,	  // 83
	MAGIC_EFFECT_NOVOFIVEEVEN = 0x59,	  // 84
	MAGIC_EFFECT_NOVOSIXEVEN = 0x60,	  // 85
	MAGIC_EFFECT_NOVOSEVENEVEN = 0x61,	  // 86
	MAGIC_EFFECT_NOVOEIGHTEVEN = 0x62,	  // 87
	MAGIC_EFFECT_NOVONINEEVEN = 0x63,	  // 88
	MAGIC_EFFECT_NOVOTWENTY = 0x64,		  // 89
	MAGIC_EFFECT_NOVOTWENTYONE = 0x65,	  // 90
	MAGIC_EFFECT_NOVOTWENTYTWO = 0x66,	  // 91
	MAGIC_EFFECT_NOVOTWENTYTHREE = 0x67,  // 92
	MAGIC_EFFECT_NOVOTWENTYFOUR = 0x68,	  // 93
	MAGIC_EFFECT_NOVOTWENTYFIVE = 0x69,	  // 94
	MAGIC_EFFECT_NOVOTWENTYSIX = 0x70,	  // 95
	MAGIC_EFFECT_NOVOTWENTYSEVEN = 0x71,  // 96
	MAGIC_EFFECT_NOVOTWENTYEIGHT = 0x72,  // 97
	MAGIC_EFFECT_NOVOTWENTYNINE = 0x73,	  // 98
	MAGIC_EFFECT_NOVOTHREETY = 0x74,	  // 99
	MAGIC_EFFECT_NOVOTHREETYONE = 0x75,	  // 100
	MAGIC_EFFECT_NOVOTHREETYTWO = 0x76,	  // 101
	MAGIC_EFFECT_NOVOTHREETYTHREE = 0x77, // 102
	MAGIC_EFFECT_NOVOTHREETYFOUR = 0x78,  // 103
	MAGIC_EFFECT_NOVOTHREETYFIVE = 0x79,  // 104
	MAGIC_EFFECT_NOVOTHREETYSIX = 0x80,	  // 105
	MAGIC_EFFECT_NOVOTHREETYSEVEN = 0x81, // 106
	MAGIC_EFFECT_NOVOTHREETYEIGHT = 0x82, // 107
	MAGIC_EFFECT_NOVOTHREETYNINE = 0x83,  // 108
	MAGIC_EFFECT_NOVOFOURTY = 0x84,		  // 109
	MAGIC_EFFECT_NOVOFOURTYONE = 0x85,	  // 110
	MAGIC_EFFECT_NOVOFOURTYTWO = 0x86,	  // 111
	MAGIC_EFFECT_NOVOFOURTYTHREE = 0x87,  // 112
	MAGIC_EFFECT_NOVOFOURTYFOUR = 0x88,	  // 113
	MAGIC_EFFECT_NOVOFOURTYFIVE = 0x89,	  // 114
	MAGIC_EFFECT_NOVOFOURTYSIX = 0x90,	  // 115
	MAGIC_EFFECT_NOVOFOURTYSEVEN = 0x91,  // 116
	MAGIC_EFFECT_NOVOFOURTYEIGHT = 0x92,  // 117
