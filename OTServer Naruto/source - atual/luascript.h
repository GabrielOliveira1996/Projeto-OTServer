...
protected:
	...
	static int32_t luaGetPlayerAkamaruNextLevelExp(lua_State *L);
	...
	// Kiba
	static int32_t luaCreateJuujinBunshin(lua_State *L);
	static int32_t luaGetPlayerAkamaruLevel(lua_State *L);
	static int32_t luaGetPlayerAkamaruExp(lua_State *L);
	static int32_t luaGetPlayerAkamaruPoints(lua_State *L);
	static int32_t luaGetPlayerAkamaruAttack(lua_State *L);
	static int32_t luaGetPlayerAkamaruAgility(lua_State *L);
	static int32_t luaGetPlayerAkamaruDodge(lua_State *L);
	static int32_t luaGetPlayerAkamaruHealthPts(lua_State *L);
	static int32_t luaGetPlayerAkamaruSpeedPts(lua_State *L);
	static int32_t luaSetPlayerAkamaruAttack(lua_State *L);
	static int32_t luaSetPlayerAkamaruAgility(lua_State *L);
	static int32_t luaSetPlayerAkamaruDodge(lua_State *L);
	static int32_t luaSetPlayerAkamaruHealthPts(lua_State *L);
	static int32_t luaSetPlayerAkamaruPoints(lua_State *L);
	static int32_t luaGetPlayerAkamaruMaxHealth(lua_State *L);
	static int32_t luaGetPlayerAkamaruMaxSpeed(lua_State *L);
	static int32_t luaSendAkamaruData(lua_State *L);
	static int32_t luaGetAkamaruState(lua_State *L);
	static int32_t luaGetReviveAkamaru(lua_State *L);
	static int32_t luaSetAkamaruOutfit(lua_State *L);
	static int32_t luaGetAkamaruOutfit(lua_State *L);
	// Naruto
	static int32_t luaCreateBunshin(lua_State *L);
	...
	static int32_t luaDoPlayerRemoveMana(lua_State *L);
