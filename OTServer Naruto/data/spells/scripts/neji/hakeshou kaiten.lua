...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -0.5, -500, -1.5, -650)
...
if exhaustion.check(cid, 20001) == false then
addEvent(onCastSpell1, 100, parameters)
addEvent(onCastSpell2, 100, parameters)
exhaustion.set(cid, 20001, 2)
return true
else
doPlayerSendCancel(cid, "Cooldown[" ..exhaustion.get(cid, 20001).."]")
end
end
