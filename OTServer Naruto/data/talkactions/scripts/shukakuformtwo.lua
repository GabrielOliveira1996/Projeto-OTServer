...
local vocation = 75 -- Vocation ID
local mana = 200 -- Mana necessária
local outfit = {lookType = 71, lookHead = 0, lookBody = 0, lookLegs = 0, lookFeet = 0, lookTypeEx = 0, lookAddons = 0} -- Outfit
...
setPlayerStorageValue(cid, 8165, getPlayerVocation(cid))
doSetCreatureOutfit(cid, outfit, -1)
doPlayerSetVocation(cid, vocation)
addEvent(doPlayerSetVocation, tempo*1000, cid, getPlayerStorageValue(cid, 8165))
