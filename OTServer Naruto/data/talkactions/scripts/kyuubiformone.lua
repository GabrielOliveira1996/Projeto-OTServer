...
local vocation = 64 -- Vocation ID
local mana = 100 -- Mana necessária
local outfit = {lookType = 354, lookHead = 0, lookBody = 0, lookLegs = 0, lookFeet = 0, lookTypeEx = 0, lookAddons = 0} -- Outfit
...
addEvent(doPlayerSetVocation, tempo*1000, cid, getPlayerStorageValue(cid, 8153))
