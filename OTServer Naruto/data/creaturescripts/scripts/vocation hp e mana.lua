local vocacoes_bonus = {
    ...
    --["Shino Shippuden"]     = {vida = 1000, mana = 2000, storage = 65498},
    ...
    --["Hinata Shippuden"]    = {vida = 1500, mana = 1500, storage = 65498},
    ...
    --["Shino Master Of Insects"]      = {vida = 2000, mana = 3000, storage = 65499},
    ...
    --["Hinata Stronger"]              = {vida = 2500, mana = 2500, storage = 65499},
...
function onLogin(cid)
    ...
    if config then
        if getPlayerStorageValue(cid, config.storage) < 1 then
            ...
            -- Cura o HP/Mana ganho para não ficar com a barra vazia
