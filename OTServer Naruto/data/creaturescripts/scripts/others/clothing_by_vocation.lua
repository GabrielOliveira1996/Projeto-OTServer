function onLogin(cid)
        ...
        [19] = {Type=174}, -- shino x
        [20] = {Type=174}, -- shino x
        [21] = {Type=175}, -- shino shippuden x
        [22] = {Type=175}, -- shino master of insects x
        [21] = {Type=4}, -- kankuro  
        ...
        [40] = {Type=353}, -- naruto thirt form x
        ...
        [64] = {Type=188}, -- kyuubi 1
        [65] = {Type=188}, -- kyuubi 2
        [66] = {Type=188}, -- kyuubi 3
        [67] = {Type=188}, -- kyuubi 3 shippuden
        [68] = {Type=351}, -- kyuubi 4
        [69] = {Type=164}, -- sanin mode
        [84] = {Type=350}, -- kyuubi sanin mode
        [81] = {Type=188}, -- kyuubi chakra full
        ...
        if getPlayerVocation(cid) >= 0 and getPlayerVocation(cid) <=105 then
                ...
                doPlayerSendTextMessage(cid,26,"Unconfigured vocation.")
        end
        return true
end
