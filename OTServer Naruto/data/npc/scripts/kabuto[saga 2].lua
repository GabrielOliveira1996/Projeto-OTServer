...
local storagelose = 11145 -- storage que vai perder
local storageGain = 11146 -- storage que vai receber
local var = 25000

if msgcontains(msg, 'talk') and getPlayerStorageValue(cid, storagelose) > -1 then
selfSay('Hahaha saia daqui seu perdedor essa batalha são para os grandes...', cid)
