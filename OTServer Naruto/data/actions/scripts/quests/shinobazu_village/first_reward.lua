function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getPlayerStorageValue(cid, STORAGE_SHINOBAZU_FIRST_REWARD) ~= -1 then
    ...
    local itemsToGive = {
        ...
        {id = 7452, count = 1,  weight = 30.0}, -- guren no gouken
        {id = 2396, count = 1,  weight = 32.0}, -- akatsume dagger
    ...
    if bag then
        ...
        setPlayerStorageValue(cid, STORAGE_SHINOBAZU_FIRST_REWARD, 1)
    else
