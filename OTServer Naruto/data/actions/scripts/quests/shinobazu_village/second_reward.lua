function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getPlayerStorageValue(cid, STORAGE_SHINOBAZU_SECOND_REWARD) ~= -1 then
    ...
    local itemsToGive = {
        ...
        {id = 2650, count = 1,  weight = 300.0}, -- gangan shoes
    ...
    if bag then
        ...
        setPlayerStorageValue(cid, STORAGE_SHINOBAZU_SECOND_REWARD, 1)
    else
