function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getPlayerStorageValue(cid, STORAGE_BANDIT_CAVE) ~= -1 then
    ...
    local itemsToGive = {
        {id = 2152, count = 20, weight = 0.1}, -- green notes
        {id = 2423, count = 1,  weight = 100.0}, -- iron gloves
        {id = 2413, count = 1,  weight = 53.0}, -- mystic sword
        {id = 2399, count = 50, weight = 0.8}, -- shurikens
        {id = 2151, count = 10, weight = 0.2}  -- genin pills
    }
    ...
    if bag then
        ...
        setPlayerStorageValue(cid, STORAGE_BANDIT_CAVE, 1)
    else
