function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getPlayerStorageValue(cid, STORAGE_TOWER_QUEST) ~= -1 then
    ...
    local itemsToGive = {
        ...
        {id = 2424, count = 1,  weight = 200.0}, -- metal gloves
        {id = 2403, count = 1,  weight = 21.0}, -- samurai sword
        {id = 2546, count = 50, weight = 0.8}, -- explosive kunai
        {id = 2151, count = 40, weight = 0.2}  -- genin pills
    }
    ...
    if bag then
        ...
        setPlayerStorageValue(cid, STORAGE_TOWER_QUEST, 1)
    else
