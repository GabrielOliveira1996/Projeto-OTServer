...
int32_t Spell::getManaCost(const Player* player) const
{
    ...
    // se não houver player ou a mana for 0, retorna o valor base
    ...
    int32_t limit = baseMana / 2; // o custo não pode cair mais que 50%
    int32_t discounted = baseMana - fishingSkill; // aqui é subtração porque baseMana é positivo
