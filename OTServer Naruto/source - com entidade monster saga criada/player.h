...
/*struct AkamaruData
{
	...
	AkamaruData() : level(1), exp(0), points(0), attack(0),
					agility(0), dodge(0), healthPts(0), speedPts(0) {}

	void addExperience(uint64_t gain, Player *master);
	uint64_t getRequiredExp(uint32_t lvl) const;
};*/
...
public:
	...
	//AkamaruData *getAkamaruData() const { return akamaruData; }
	//void setAkamaruData(AkamaruData *data) { akamaruData = data; }
