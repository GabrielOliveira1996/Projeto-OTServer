...
void LuaScriptInterface::registerFunctions()
{
	...
	// luaGetPlayerAkamaruNextLevelExp
...
/*int32_t LuaScriptInterface::luaGetPlayerAkamaruLevel(lua_State *L)
{
	ScriptEnviroment *env = getEnv();
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->level);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruExp(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, (double)player->getAkamaruData()->exp);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruPoints(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->points);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruAttack(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->attack);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruAgility(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->agility);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruDodge(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->dodge);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruHealthPts(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->healthPts);
	else
		lua_pushnil(L);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruSpeedPts(lua_State *L)
{
	...
	Player *player = env->getPlayerByUID(popNumber(L));
	if (player && player->getAkamaruData())
		lua_pushnumber(L, player->getAkamaruData()->speedPts);
	else
		lua_pushnil(L);
	return 1;
}*/
...
/*int32_t LuaScriptInterface::luaSetPlayerAkamaruAttack(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		player->getAkamaruData()->attack = value;
		lua_pushboolean(L, true);
	}
	else
		lua_pushnil(L);
...
int32_t LuaScriptInterface::luaSetPlayerAkamaruAgility(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		player->getAkamaruData()->agility = value;
		lua_pushboolean(L, true);
	}
	else
		lua_pushnil(L);
...
int32_t LuaScriptInterface::luaSetPlayerAkamaruDodge(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		player->getAkamaruData()->dodge = value;
		lua_pushboolean(L, true);
	}
	else
		lua_pushnil(L);
...
int32_t LuaScriptInterface::luaSetPlayerAkamaruHealthPts(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		player->getAkamaruData()->healthPts = value;
		lua_pushboolean(L, true);
	}
	else
		lua_pushnil(L);
...
int32_t LuaScriptInterface::luaSetPlayerAkamaruPoints(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		player->getAkamaruData()->points = value;
		lua_pushboolean(L, true);
	}
	else
		lua_pushnil(L);
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruMaxHealth(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		// Usa a fórmula: Base 150 + (pontos * 10)
		lua_pushnumber(L, 150 + (player->getAkamaruData()->healthPts * 10));
	}
	else
		lua_pushnil(L);
	return 1;
...
int32_t LuaScriptInterface::luaGetPlayerAkamaruMaxSpeed(lua_State *L)
{
	...
	if (player && player->getAkamaruData())
	{
		// Usa a fórmula: Base 200 + (pontos * 5)
		lua_pushnumber(L, 200 + (player->getAkamaruData()->speedPts * 5));
	}
	else
		lua_pushnil(L);
	return 1;
