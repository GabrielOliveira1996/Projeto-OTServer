...
public:
	...
	const InstantsMap &getInstants() const { return instants; }
...
public:
	...
	const VocationMap &getVocations() const { return vocSpellMap; }
	...
	uint16_t getSpellId() const { return spellId; }
	uint16_t getIconId() const { return iconId; }
