...
template <class T>
class lessPointer : public std::binary_function<T *, T *, bool>
{
public:
...
public:
	...
	static const int32_t maxViewportX = 23; // min value: maxClientViewportX + 1
	static const int32_t maxViewportY = 9;	// min value: maxClientViewportY + 1
	static const int32_t maxClientViewportX = 22;
