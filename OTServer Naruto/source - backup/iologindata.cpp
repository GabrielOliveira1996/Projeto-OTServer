...
bool IOLoginData::loadPlayer(Player *player, const std::string &name, bool preLoad /*= false*/)
{
	...
	if (!preLoad)
	{
		...
		akamaruQuery << "SELECT `level`, `exp`, `points`, `attack`, `agility`, `dodge`, `health_pts`, `speed_pts` "
...
bool IOLoginData::savePlayer(Player *player, bool preSave /* = true*/, bool shallow /* = false*/)
{
	...
	akamaruSave << "INSERT INTO `player_akamarus` (`player_id`, `level`, `exp`, `points`, `attack`, `agility`, `dodge`, `health_pts`, `speed_pts`) VALUES ("
				<< player->getGUID() << ", "
				<< player->akamaruLevel << ", "
				<< player->akamaruExp << ", "
