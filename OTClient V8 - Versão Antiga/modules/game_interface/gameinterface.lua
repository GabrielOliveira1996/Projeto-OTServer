...
function updateSize()
  if updatingSize or not gameRootPanel or not gameMapPanel then
    return
  end
  ...
  -- Se o número for par, somamos 1.
  if viewWidth % 2 == 0 then
    viewWidth = viewWidth + 1
  end

  -- Trava de segurança (Também ímpar!)
  if viewWidth > 29 then viewWidth = 29 end

  gameMapPanel:setVisibleDimension({width = viewWidth, height = viewHeight})
  gameMapPanel:setKeepAspectRatio(true)
  gameMapPanel:setMargin(0)
