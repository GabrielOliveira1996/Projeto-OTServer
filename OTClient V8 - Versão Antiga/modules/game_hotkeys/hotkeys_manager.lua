...
function online()
  ...
  addEvent(function()
    ...
    if topMenu then
      local button = topMenu.getButton('hotkeysButton')
      if button then
        button:destroy()
      end
    end
    ...
    if modules.game_buttons then
      local buttonsPanel = modules.game_buttons.buttonsWindow:getChildById('buttons')
      if buttonsPanel then
        local b = buttonsPanel:getChildById('hotkeysButton')
