locale = {
  ...
  translation = {
    ...
    ["Overrides 'Auto-Chase' when motion input is detected.\nImproves fluidity for kiting and prevents the character from getting stuck in the target's path when trying to dodge."] = "Substitui a função 'Perseguição Automática' quando detecta entrada de movimento.\nMelhora a fluidez ao se esquivar e impede que o personagem fique preso no caminho do alvo ao tentar desviar.",
    ...
    ["Buy"] = "Comprar",
    ["Cancel"] = "Cancelar",
    ["Cannot login while already in game."] = "Não é possível logar enquanto já estiver jogando.",
    ["Cap"] = "Cap",
    ["Capacity"] = "Capacidade",
    ["Center"] = "Centro",
    ...
    ["Activate classic controls: Right button to move and use objects, left button to select and attack."] = "Ativa o controle clássico: Botão direito para andar e usar objetos, botão esquerdo para selecionar e atacar.",
    ...
    ["Close"] = "Fechar",
    ["Club Fighting"] = "Velocidade de ataque",
    ...
    ["Enable fast walking (DASH)"] = "Ativar andar rápido (DASH)",
    ["Allows to execute next move without server confirmation of previous one."] = "Permite executar a próxima jogada sem a confirmação do servidor da jogada anterior.",
    ["Enable smart walking"] = "Ativar andar inteligente",
    ["Will detect when to use diagonal step based on the keys you are pressing."] = "Detectará quando usar o passo diagonal com base nas teclas que você estiver pressionando.",
    ...
    ["Layout (change requries client restart)"] = "Layout (mudança requer reinício do cliente)",
    ["Exit"] = "Sair",
    ...
    ["Find"] = "Procurar",
    ["Fishing"] = "Controle de Chakra",
    ["Fist Fighting"] = "Taijutsu",
    ["Follow"] = "Seguir",
    ["For Your Information"] = "Para sua informações",
    ...
    ["Hide spells for higher exp. levels"] = "Esconder jutsus de nível maior",
    ...
    ["Mount"] = "Montar",
    ["Move Stackable Item"] = "Mover item contóvel",
    ...
    ["Unable to load dat file, please place a valid dat in '%s'"] = "Não foi possível carregar o arquivo DAT, por favor coloque um arquivo vlido em %s",
    ["Unable to load spr file, please place a valid spr in '%s'"] = "Não foi possível carregar o arquivo SPR, por favor coloque um arquivo vlido em %s",
    ["Unable to logout."] = "Não é possível sair",
    ["Unignore"] = "Designorar",
    ["Unload"] = "Descarregar",
