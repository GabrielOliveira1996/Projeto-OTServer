...
-- REFER√äNCIAS GLOBAIS PARA O OPTIONS.LUA
topHealthBar = nil
topManaBar = nil
healthCircle = nil
manaCircle = nil
...
function onHealthChange(localPlayer, health, maxHealth)
    ...
    if healthCircleFront then
        -- 1. Calculamos o percentual com seguranÁa
        ...
        -- 2. Calculamos a altura do clip (Total da imagem È 208)
...
function onManaChange(localPlayer, mana, maxMana)
    ...
    if manaCircleFront then
        ...
        if clipHeight <= 0 then
            ...
            manaCircleFront:setVisible(false) -- Esconde o c√≠rculo se a mana for 0
        else
