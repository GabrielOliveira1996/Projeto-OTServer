MessageSettings = {
  ...
  -- 
  centerRed       = { color = TextColors.red,    screenTarget='lowCenterLabel', consoleTab='Server Log' },
  centerGreen     = { color = TextColors.green,  screenTarget='highCenterLabel', consoleTab='Server Log' },
  centerWhite     = { color = TextColors.white,  screenTarget='middleCenterLabel', consoleTab='Server Log' },
  
  -- 
  bottomWhite     = { color = TextColors.white,  screenTarget='statusLabel', consoleTab='Server Log' },
  status          = { color = TextColors.white,  screenTarget='statusLabel', consoleTab='Server Log' },
  statusSmall     = { color = TextColors.white,  screenTarget='statusLabel', consoleTab='Server Log' },
