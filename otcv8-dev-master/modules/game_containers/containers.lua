...
function onContainerOpen(container, previousContainer)
  ...
  if previousContainer then
    ...
    local containerParent = (modules.game_interface.getContainerPanel and modules.game_interface.getContainerPanel())
      or modules.game_interface.getRootPanel()
      or g_ui.getRootWidget()
    containerWindow = g_ui.createWidget('ContainerWindow', containerParent)
